...
-- CreateEnum
CREATE TYPE "CountryCode" AS ENUM ('INDIA', 'AMERICA');
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "payment_methods"("id") ON DELETE SET NULL ON UPDATE CASCADE;
